                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center" style="min-height: 80vh;">
                            <div class="col-md-6 px-5">
                                ...
                                <div class="mt-4">
                                    <a href="experience.php" class="btn btn-dark btn-lg mr-2">Read More</a>
                                    <a href="#" class="btn btn-outline-dark btn-lg">Download CV</a>
                                </div>
                            </div>
                            <div class="col-md-6 text-center">
                                <img src="../dist/assets/img/FahmiAlamsyahN.jpeg" class="img-fluid" style="max-height: 500px; filter: grayscale(100%);" alt="Fahmi Profile">
                            </div>
                        </div>
                    </div>
                </section>
            </div>
            <!-- /.row profile (main row) -->
